...
namespace BlogApp_Net8.Controllers
{
    public class CommentsController : Controller
    {
        ...
        {
            var blogDbContext = _context.Comments.Include(c => c.Article).Include(c => c.User);
        ...
        public async Task<IActionResult> Create([Bind("Id,Body,CreateDate,ArticleId,UserId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Body,CreateDate,ArticleId,UserId")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
